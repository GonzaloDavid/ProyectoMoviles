...
public class AdministrarPuerta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_administrar_puerta);
    }
    ...
    {
        spinner1 = (Spinner) findViewById(R.id.spinnerp);
